...
const moods = [
  ...
  { title: "Romantic Escapes", img: romantic, link: "https://travel.rethinkways.com/category/romantic-escapes/" },
        ...
        {moods.map((item, i) => (
          ...
          >
            ...
            <button className="absolute bottom-3 right-3 md:bottom-4 md:right-4 flex items-center gap-1 bg-white text-black text-[11px] md:text-[14px] px-3 md:px-4 py-[5px] md:py-[6px] rounded-full font-medium shadow-sm transition-all duration-300">
              View All
              <span className="inline-block -rotate-45 transition-transform duration-300 group-hover:rotate-0 group-hover:translate-x-1">
                →
              </span>
            </button>
          </a>
